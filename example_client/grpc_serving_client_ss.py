...
parser.add_argument('--output_name',required=False, default='hm',
                    help='Specify output name. default: resnet_v1_50/predictions/Reshape_1')
parser.add_argument('--transpose_input', choices=["False", "True"], default="False",
...
parser.add_argument('--batchsize', default=1,
                    ...
                    dest='batchsize')
parser.add_argument('--model_name', default='head_det_res18_512x288_dynamic_fp16', help='Define model name, must be same as is in service. default: resnet',
                    dest='model_name')
